...
urlpatterns = [
    ...
    path('courses/<id>/modules/', ModuleList.as_view(), name='module-list'),
    path('modules/<id>/lessons/', LessonList.as_view(), name='lesson-list'),
    path('modules/<id>/quizzes/', QuizList.as_view(), name='quiz-list'),
    path('quizzes/<id>/questions/', QuestionList.as_view(), name='question-list'),
    path('questions/<id>/options/', OptionList.as_view(), name='option-list'),
    path('resources/', ResourceList.as_view(), name='resource-list'),
    path('quizzes/<id>/', ScoreList.as_view(), name='score-list'),
]
