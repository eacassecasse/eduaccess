...
function SignUp() {
    return (
        <form className="w-96 flex flex-col flex-nowrap items-center justify-center px-8 pt-10 pb-14 shadow-lg rounded-md gap-10 border">
            ...
            <div className="flex flex-col flex-nowrap w-full gap-8">
                <div>
                    <input type="text" placeholder="First Name" className="flex w-full gap-3 px-3 py-4 bg-white border border-slate-200 rounded-md font-normal text-sm text-slate-800 shadow-sm placeholder-slate-400
    ...
    "/>
                ...
                <div>
                    <input type="text" placeholder="Last Name" className="flex w-full gap-3 px-3 py-4 bg-white border border-slate-200 rounded-md font-normal text-sm text-slate-800 shadow-sm placeholder-slate-400
      focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500
      disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none
      invalid:border-pink-500 invalid:text-pink-600
      focus:invalid:border-pink-500 focus:invalid:ring-pink-500
